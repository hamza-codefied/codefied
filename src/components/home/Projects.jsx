...
const ProjectsSection = () => {
  ...
  return (
    <div className='container m-auto'>
      <section id='projects' className='mt-0 sm:mt-10 pt-5 sm:pt-[200px] bg-white px-4 sm:px-6 md:px-8' style={{ overflowX: 'hidden' }}>
        {/* Tag */}
        ...
        <div className='flex flex-col md:flex-row items-start justify-between gap-6 sm:gap-8 mt-4 sm:mt-5 mb-8 sm:mb-16 md:mb-[108px]'>
          ...
          <div className='w-full md:w-2/3'>
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 relative inline-block">
              ...
              <span className="block w-[150px] sm:w-[180px] md:w-[200px] lg:w-[240px] h-[1px] bg-gray-500 mt-2 sm:mt-3 md:mt-5 rounded-full"></span>
            </h2>
          </div>
          ...
          <div className="w-full md:w-[350px]">
            ...
            <div className="flex items-center justify-start md:justify-end pr-0 md:pr-5 font-semibold">
              ...
              <FaArrowRightLong className="ml-2 sm:ml-[14px] text-[#d4575b]" size={18} style={{ fontSize: 'clamp(16px, 4vw, 20px)' }} />
            </div>
          </div>
        ...
        >
          ...
          <div className="flex gap-2 sm:gap-3 md:gap-4">
            <motion.button
              whileHover={{ scale: 1.1, rotate: -5, backgroundColor: "#D4575B", borderColor: "transparent" }}
              whileTap={{ scale: 0.9 }}
              onClick={handlePrev}
            ...
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 transition-all group-hover:stroke-white group-hover:-translate-x-1" fill="none" viewBox="0 0 24 24" stroke="black" strokeWidth={2.5}>
