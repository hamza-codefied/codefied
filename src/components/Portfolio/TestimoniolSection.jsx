...
export default function TestimonialsSection() {
  ...
  return (
    <section
      ref={ref}
      className='w-full bg-white py-16 px-6 md:px-12 lg:px-20 flex flex-col md:flex-row items-start justify-between gap-10 mt-5 sm:mt-10 max-w-full mx-auto'
      style={{ backgroundImage: "url('/src/images/shade.png')" }}
    >
      {/* Left Side */}
      <motion.div
